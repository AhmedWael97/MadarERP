...
const meta = {
  "routePath": "/fleet/billing",
  "titleKey": "pages:page.fleet.billing.title",
  "doctype": null,
  "viewType": "list",
  "module": "fleet",
  "screenshot": "screenshots\\070_المستخلصات-التشغيلية.png"
} as const;
...
export const columns: ColumnDef[] = [
  ...
  },
  {
    "id": "col_8",
    "header": "الحالة",
    "headerKey": "page..col.8"
  },
  {
    "id": "col_9",
    "header": "إجراءات",
    "headerKey": "page..col.9"
  }
];

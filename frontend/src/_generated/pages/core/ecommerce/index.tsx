...
export default function Page() {
  ...
  return (
    <PageShell title={t(meta.titleKey, { defaultValue: "E-commerce Dashboard" })} actions={<Link to="/ecommerce/create" className="inline-flex items-center gap-2 px-4 py-2.5 bg-emerald-600 text-white text-sm font-bold rounded-xl hover:bg-emerald-500 transition-all shadow-sm"><Plus size={16} />{t('action.create')}</Link>}>

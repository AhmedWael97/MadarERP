...
export default function PurchaseAgingPage() {
  ...
  return (
    <FinancialReportShell
      title="أعمار ديون المشتريات"
      subtitle="أعمار الديون المستحقة للموردين"
      reportName="Accounts Payable"
      filters={{ report_date: reportDate, ageing_based_on: 'Posting Date', range1: 30, range2: 60, range3: 90, range4: 120, party_type: 'Supplier' }}

/** المبيعات اليومية — uses ERPNext "Sales Register". */
...
const COLUMNS: ReportColumn[] = [
  ...
  { label: 'صافي قبل الضريبة', fieldname: 'net_total', numeric: true },
  { label: 'الضرائب', fieldname: 'total_taxes_and_charges', numeric: true },
  { label: 'الخصومات', fieldname: 'discount_amount', numeric: true },

        ...
        groups: [
          ...
          // ── Task 3: debt aging moved under Customers.
          {
            ...
            leaves: [
              ...
              { to: '/customers/reports/statement', labelAr: 'كشف حساب العملاء' },
              { to: '/customers/reports/totals', labelAr: 'إجمالي العملاء' },
            ],
          },
        ],
      },
      {
        ...
        groups: [
          ...
          },
          {
            headerAr: '📊 التقارير',
            leaves: [
              { to: '/suppliers/reports/statement', labelAr: 'كشف حساب الموردين' },
              { to: '/accounting/reports/mixed-parties-statement', labelAr: 'كشف حساب العملاء/الموردين' },
            ],
          },
        ],
      },
        ...
        groups: [
          ...
          },
          {
            ...
            leaves: [
              ...
              { to: '/sales/reports/by-sales-rep', labelAr: 'تقرير المندوبين' },
              ...
              { to: '/sales/reports/commissions',  labelAr: 'تقرير العمولات' },
              { to: '/sales/commission-policies',  labelAr: 'سياسة العمولة' },
            ],
          },
        ],
      },
